...
public class DateUtil {
	...
	public static String[] MMM = { "", "JAN", "FEB", "MAR", "APR", "MAY",
			"JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC" };

	public static String[] DD = { "", "01", "02", "03", "04", "05", "06", "07",
	 ...
	 * 
	 * @param utc
	 *            string in format ex: 1997-07-16T19:20+01:00
	 ...
	 * @param utc
	 *            string in format ex: 1997-07-16T19:20+01:00
	 * @return Returns parsed date, returns given value for param:'otherwise' if
	 *         could not be parsed.
	 * @throws ParseException
	 */
	...
	/**
	 * Returns Month Name for the given Month Number {1=JAN, 2=FEB,
	 * 3=MAR.....12=DEC}
	 * 
	 * @param mm
	 * @return
